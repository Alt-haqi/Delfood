...
class Makanan extends CI_Controller
{
    ...
    {
        $data['title'] = 'Artikel Resep';
        $data['makanan'] = $this->Makanan_model->getAllMakanan();
        $data['kategori'] = $this->Kategori_model->get_all_kategori()->result_array();
